...
app.post("/scan", (req, res) => {
    ...
    // Let us convert the input stored in the url and return it as
    //  a representation of the QR Code image contained in the Data URI(Uniform Resource Identifier)
